package com.nusantarabetastudio.hellokotlin.adapter
...
import com.nusantarabetastudio.hellokotlin.R
import com.nusantarabetastudio.hellokotlin.model.Item
...
class RecyclerViewAdapter(private val context: Context, private val items: List<Item>,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerViewViewHolder {
        return RecyclerViewViewHolder(LayoutInflater.from(context).inflate(R.layout.item_list, parent, false))
    }
